...
**茅ヶ崎ヘッドランド 救助連携シミュレーター・Beta**

（開発中）要救助者の配置や環境条件を設定し、チューブ・ボード・IRB・PWCなどの救助連携を画面上で確認できます。
...
データを取得できなかったときや古いときは、「異常なし」「警報なし」とは表示せず、その旨を画面に出す方針です（[開発原則](https://github.com/edi-tool/.github/blob/main/PRINCIPLES.md)）。
